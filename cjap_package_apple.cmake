...
if(CJAP_PACKAGE_ENABLED AND APPLE)
  ...
  file(APPEND "${CJAP_PACKAGE_PACKAGER_FILE_PATH}" "    pkgbuild --analyze --nopayload --root \"$pkgdir\" \"${CJAP_PACKAGE_BUILD_PATH}/$name.plist\"\n")
  file(APPEND "${CJAP_PACKAGE_PACKAGER_FILE_PATH}" "    pkgbuild --nopayload --component-plist \"${CJAP_PACKAGE_BUILD_PATH}/$name.plist\" --root \"$pkgdir\" --identifier \"\$pkgid\" --version \"\$pkgversion\" \"\$pkgtarget\" || exit 1\n")
