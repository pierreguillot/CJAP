...
function(target_enable_apple_generic_package target tformat format destination)
  if(TARGET ${target}_${tformat})
    ...
    file(APPEND "${CJAP_PACKAGE_PACKAGER_FILE_PATH}" "build_target_format_pkg \"${PACKAGE_NAME}\" \"${format}\" \"${PLUGIN_ARTEFACT_DIR}\" \"${PLUGIN_ARTEFACT_FILE}\" \"${PACKAGE_ID}\" \"${destination}\"\n")
