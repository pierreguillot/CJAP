...
if(CJAP_PACKAGE_ENABLED AND APPLE)
  ...
  file(APPEND "${CJAP_PACKAGE_PACKAGER_FILE_PATH}" "    pkgbuild --analyze --root \"$pkgdir/$sourcename\" \"$pkgdir/$name.plist\"\n")
  ...
  file(APPEND "${CJAP_PACKAGE_PACKAGER_FILE_PATH}" "    pkgbuild ${SIGN_CMD} --root \"$pkgdir/$sourcename\" --identifier \"\$pkgid\" --version \"\$pkgversion\" --install-location \"\$pkgdestination\" \"\$pkgtarget\" || exit 1\n")
  if(CJAP_CODESIGN_ENABLED)
