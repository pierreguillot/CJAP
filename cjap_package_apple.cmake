...
if(CJAP_PACKAGE_ENABLED AND APPLE)
  ...
  find_program(PACKAGESBUILD_EXE "packagesbuild")
  if(PACKAGESBUILD_EXE)
    ...
    message(WARNING "${CJAP_PACKAGE_PROJECT_NAME}_Package cannot be generated because packagesbuild is not found")
  endif()
