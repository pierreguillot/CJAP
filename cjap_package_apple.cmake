...
if(CJAP_PACKAGE_ENABLED AND APPLE)
  ...
  file(APPEND "${CJAP_PACKAGE_PACKAGER_FILE_PATH}" "    pkgbuild ${SIGN_CMD} --component-plist \"${CJAP_PACKAGE_BUILD_PATH}/$name.plist\" --root \"$pkgdir\" --identifier \"\$pkgid\" --version \"\$pkgversion\" --install-location \"\$pkgdestination\" \"\$pkgtarget\" || exit 1\n")
  if(CJAP_CODESIGN_ENABLED)
