...
if(CJAP_PACKAGE_ENABLED AND WIN32)
  ...
  if(ISCC_EXE)
    add_custom_target(${CJAP_PACKAGE_PROJECT_NAME}_Package ALL ${ISCC_EXE} /DMyRefDir=${PLUGIN_REFERENCE_FOLDER} /DMyConfig=$<CONFIG> /O${CJAP_PACKAGE_INSTALL_DIR} ${CJAP_PACKAGE_ISS_FILE_PATH})
...
function(target_enable_windows_cjap_package target)
  if(CJAP_PACKAGE_ENABLED AND WIN32)
    ...
    if(TARGET ${target}_VST3)
      file(APPEND "${CJAP_PACKAGE_ISS_FILE_PATH}" "Source: \"{#MyRefDir}\\VST3\\{#MyConfig}\\${PLUGIN_NAME}.vst3\\*\"; DestDir: \"{commoncf64}\\VST3\\${PLUGIN_NAME}.vst3\"; Flags: recursesubdirs ignoreversion\n")
    endif()
    if(TARGET ${target}_AAX)
      file(APPEND "${CJAP_PACKAGE_ISS_FILE_PATH}" "Source: \"{#MyRefDir}\\AAX\\{#MyConfig}\\${PLUGIN_NAME}.aaxplugin\\*\"; DestDir: \"{commoncf64}\\Avid\\Audio\\Plug-Ins\\${PLUGIN_NAME}.aaxplugin\"; Flags: recursesubdirs ignoreversion\n")
    endif()
    if(TARGET ${target}_Standalone)
      file(APPEND "${CJAP_PACKAGE_ISS_FILE_PATH}" "Source: \"{#MyRefDir}\\Standalone\\{#MyConfig}\\${PLUGIN_NAME}.exe\"; DestDir: \"{app}\"; Flags: ignoreversion\n")
    endif()
  endif()
