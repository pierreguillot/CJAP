  ...
  if(CJAP_CODESIGN_ENABLED AND EXISTS ${CJAP_CODESIGN_WINDOWS_CERTFILE})
    if(NOT EXISTS ${CJAP_CODESIGN_WINDOWS_CERTFILE})
      ...
      if(SIGNTOOL_EXE)
        ...
        COMMAND ${SIGNTOOL_EXE} sign /f "${CJAP_CODESIGN_WINDOWS_CERTFILE}" /p "${CJAP_PACKAGE_PROJECT_NAME}" /fd SHA256 /td SHA256 /tr ${CJAP_CODESIGN_TIMESTAMP_SERVER} ${CMAKE_CURRENT_BINARY_DIR}/${CJAP_PACKAGE_PROJECT_NAME}-install.exe
