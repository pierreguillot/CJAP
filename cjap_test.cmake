...
if(CJAP_TEST_VST3VALIDATOR_ENABLED)
  ...
  if(NOT CJAP_TEST_VST3VALIDATOR_EXE)
    if(UNIX)
      execute_process(COMMAND ${CMAKE_COMMAND} -B "${CJAP_TEST_BINARY_DIR}/Vst3Validator" -G ${CMAKE_GENERATOR} -DSMTG_ENABLE_VSTGUI_SUPPORT=OFF -DSMTG_ENABLE_VST3_HOSTING_EXAMPLES=OFF -DSMTG_ENABLE_VST3_PLUGIN_EXAMPLES=OFF -Wno-deprecated WORKING_DIRECTORY ${CJAP_TEST_VST3_SDK_DIR} OUTPUT_QUIET)
    elseif(WIN32)
