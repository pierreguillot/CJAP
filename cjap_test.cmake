...
if(CJAP_TEST_ARATESTHOST_ENABLED)
  ...
  if(NOT CJAP_TEST_ARATESTHOST_EXE)
    ...
    if(APPLE)
      ...
      execute_process(COMMAND ${CMAKE_COMMAND} . -B "${CJAP_TEST_BINARY_DIR}/AraTestHost" -G ${CMAKE_GENERATOR} "-DCMAKE_XCODE_ATTRIBUTE_CODE_SIGNING_ALLOWED=NO" "-DARA_VST3_SDK_DIR=${CJAP_TEST_VST3_SDK_DIR}" "-DARA_AUDIO_UNIT_SDK_DIR=${CJAP_TEST_AUDIOUNIT_SDK_DIR}" "-DARA_SETUP_DEBUGGING=OFF" "-DCMAKE_XCODE_ATTRIBUTE_CODE_SIGN_IDENTITY=${CMAKE_XCODE_ATTRIBUTE_CODE_SIGN_IDENTITY}" "-DCMAKE_XCODE_ATTRIBUTE_DEVELOPMENT_TEAM=${CMAKE_XCODE_ATTRIBUTE_DEVELOPMENT_TEAM}" WORKING_DIRECTORY "${CJAP_TEST_ARA_SDK_DIR}/ARA_Examples" RESULT_VARIABLE DL_RESULT OUTPUT_QUIET)
    elseif(UNIX)
    ...
    elseif(WIN32)
      execute_process(COMMAND ${CMAKE_COMMAND} . -B "${CJAP_TEST_BINARY_DIR}/AraTestHost" -G ${CMAKE_GENERATOR} -A ${CMAKE_GENERATOR_PLATFORM} "-DARA_VST3_SDK_DIR=${CJAP_TEST_VST3_SDK_DIR}" "-DARA_SETUP_DEBUGGING=OFF" WORKING_DIRECTORY "${CJAP_TEST_ARA_SDK_DIR}/ARA_Examples" RESULT_VARIABLE DL_RESULT OUTPUT_QUIET)
    endif()
    if(DL_RESULT)
