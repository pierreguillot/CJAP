...
# generates a warning.
if(CJAP_CODESIGN_ENABLED AND NOT CJAP_CODESIGN_PACE_EMAIL STREQUAL "" AND NOT CJAP_CODESIGN_PACE_WCGUID STREQUAL "")
  if(APPLE)
    ...
    if(CJAP_CODESIGN_WRAPTOOL_EXE)
      ...
      message(WARNING "AAX Plugins codesigning: cant find wraptool")
    endif()
...
function(target_enable_cjap_codesign target)
  ...
  if(CJAP_CODESIGN_ENABLED AND CJAP_CODESIGN_WRAPTOOL_EXE AND TARGET ${target}_AAX)
    if(APPLE)
