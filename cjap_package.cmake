...
# Internal
set(CJAP_PACKAGE_BUILD_PATH "${CMAKE_CURRENT_BINARY_DIR}/CJAP_Package")

if(CJAP_PACKAGE_ENABLED AND CJAP_PACKAGE_PROJECT_NAME STREQUAL "")
  message(WARNING "CJAP_PACKAGE_PROJECT_NAME is undefined")
  set(CJAP_PACKAGE_ENABLED OFF)
endif()

if(CJAP_PACKAGE_ENABLED AND CJAP_PACKAGE_PROJECT_VERSION STREQUAL "")
  message(WARNING "CJAP_PACKAGE_PROJECT_VERSION is undefined")
  set(CJAP_PACKAGE_ENABLED OFF)
endif()

if(CJAP_PACKAGE_ENABLED AND CJAP_PACKAGE_COMPANY_NAME STREQUAL "")
  message(WARNING "CJAP_PACKAGE_COMPANY_NAME is undefined")
  set(CJAP_PACKAGE_ENABLED OFF)
endif()

if(CJAP_PACKAGE_ENABLED AND CJAP_PACKAGE_COMPANY_WEBSITE STREQUAL "")
...
function(target_enable_cjap_package target)
  if(CJAP_PACKAGE_ENABLED)
    if(NOT TARGET ${CJAP_CODESIGN_PROJECT_NAME}_CodeSign)
...
function(cjap_package_add_file file destination version visible)
  if(CJAP_PACKAGE_ENABLED)
    linux_cjap_package_add_file(${file} ${destination})
    windows_cjap_package_add_file(${file} ${destination})
    apple_cjap_package_add_file(${file} ${destination} ${version} ${visible})
  endif()
